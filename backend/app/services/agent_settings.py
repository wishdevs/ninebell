...
AGENT_SETTINGS_SCHEMA: dict[str, list[SettingDef]] = {
    ...
    "trip-domestic": [
        SettingDef(
            key="fuel_eff_under_1000",
            label="기준연비(1,000cc 미만)",
            type="number",
            default=14,
            min=1,
            max=50,
            unit="km/L",
            description="1,000cc 미만 차량의 유류비 지원 계산에 쓰는 기준연비.",
        ),
        SettingDef(
            key="fuel_eff_under_1600",
            label="기준연비(1,600cc 미만)",
            type="number",
            default=9,
            min=1,
            max=50,
            unit="km/L",
            description="1,600cc 미만 차량의 유류비 지원 계산에 쓰는 기준연비.",
        ),
        SettingDef(
            key="fuel_eff_under_2000",
            label="기준연비(2,000cc 미만)",
            type="number",
            default=7,
            min=1,
            max=50,
            unit="km/L",
            description="2,000cc 미만 차량의 유류비 지원 계산에 쓰는 기준연비.",
        ),
        SettingDef(
            key="fuel_eff_over_2000",
            label="기준연비(2,000cc 이상)",
            type="number",
            default=6,
            min=1,
            max=50,
            unit="km/L",
            description="2,000cc 이상 차량의 유류비 지원 계산에 쓰는 기준연비.",
        ),
        SettingDef(
            key="fuel_unit_price",
            label="기준단가",
