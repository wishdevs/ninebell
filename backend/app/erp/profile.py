...
# 회사 직급체계(사용자 확정 2026-07-29, 상위→하위 순서). 같은 줄 = 같은 위계(감사·연구위원·
# 고문). 최하위 '팀원'은 접대비·회식비 등을 쓸 일이 없어 card_collect AI 추천에서 해당 계정을
# 제외한다(recommend 참조). 추후 직급 추가 예정.
JOB_TITLE_HIERARCHY: tuple[str, ...] = (
    "대표이사", "COO", "감사", "연구위원", "고문",
    "그룹장", "본부장", "총괄팀장", "팀장", "팀원",
)
...
# 같은 순수 이름 매칭(법인카드 본인 카드 선택)에 쓸 수 없다. 회사 직급체계 + 일반 호칭
# (프로 등 패널 실측 표기) 합집합.
_JOB_TITLES = set(JOB_TITLE_HIERARCHY) | {
    "프로", "사원", "주임", "대리", "과장", "차장", "부장", "실장",
    "이사", "상무", "전무", "부사장", "사장", "대표", "매니저",
    "선임", "책임", "수석", "연구원", "센터장", "파트장",
}
