...
사용자 확정(2026-07-20 → **2026-07-23 재확정**): 사람이름 든 적요는 추천 금지, 원본의
판/제 구분(-판매/-제품 등)은 **항상 떼고 재부착하지 않는다**(종전의 접속자 비용구분
동적 재부착은 폐지 — apply_cost_suffix 변천 docstring 참조).
"""
...
@pytest.mark.parametrize(
    ...
    [
        # 2026-07-23 사용자 재확정: 판/제 구분 접미사는 **항상 제거하고 재부착하지 않는다**
        # (종전 2026-07-20 규칙은 접속자 비용구분으로 동적 재부착이었음 — 폐지).
        ("직원 야근식대(법인카드)-판매", "판관비", "직원 야근식대(법인카드)"),
        ("직원 야근식대(법인카드)-판매", "제조원가", "직원 야근식대(법인카드)"),
        ("직원 야근식대(법인카드)-제품", "판관비", "직원 야근식대(법인카드)"),
        ("해외출장 숙박비(법인카드)-판매", "판관비", "해외출장 숙박비(법인카드)"),  # 재확정 계기 실례
        ("업무추진비(판매)", "제조원가", "업무추진비"),
        ("중식대금", "제조원가", "중식대금"),  # 구분 없던 적요 — 원문 그대로
        ("직원 야근식대(법인카드)-판매", None, "직원 야근식대(법인카드)"),
        (None, "판관비", None),
    ],
)
